...
from habitat_baselines_.rl.models import resnet
from habitat_baselines_.rl.models.rnn_state_encoder import RNNStateEncoder
from habitat_baselines_.rl.ppo import Net, Policy
...
class ResNetEncoder(nn.Module):
    ...
    def forward(self, observations):
        ...
        if self._n_input_rgb > 0:
            ...
            rgb_observations = (
                rgb_observations.to(dtype=next(self.parameters()).dtype) / 255.0  # normalize RGB
            )
